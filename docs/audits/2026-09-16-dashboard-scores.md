...
| Disponibilité : statut et cache | Un statut fourni par le client pouvait contredire son score figé. | Statut dérivé du score. Un seul score figé par jour calendaire, indépendant de la langue ; seules des données nocturnes tardives (sommeil, VFC nocturne) le recalculent. |
