...
struct ContentView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            DashboardView()
                .tabItem {
                    Label(String(localized: "tab.dashboard", defaultValue: "Dashboard", comment: "Dashboard tab"), systemImage: "heart.circle.fill")
                }
                .tag(0)
            ...
            WorkoutListView()
                .tabItem {
                    Label(String(localized: "tab.courses", defaultValue: "Courses", comment: "Courses tab"), systemImage: "figure.run")
                }
                .tag(1)
