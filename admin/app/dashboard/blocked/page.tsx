    ...
    <div className="space-y-8">
      ...
      <div className="relative bg-gradient-to-r from-rose-900 to-red-900 rounded-2xl p-8 text-white shadow-lg overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-rose-100 max-w-2xl leading-relaxed">
            Manage blocked users and IP addresses to protect the platform from abuse.
            Blocked entities will be immediately denied access to the API.
          </p>
        </div>
      </div>
        ...
        {blockedUsers.length === 0 ? (
          ...
          <div className="divide-y divide-gray-100">
            {blockedUsers.map((user) => (
              <div key={user.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <p className="font-mono text-sm font-medium text-gray-900 bg-gray-100 px-2 py-0.5 rounded border border-gray-200">{user.id}</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {blockedIPs.length === 0 ? (
          ...
          <div className="divide-y divide-gray-100">
            {blockedIPs.map((ip) => (
              <div key={ip.id} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <p className="font-mono text-sm font-medium text-gray-900 bg-gray-100 px-2 py-0.5 rounded border border-gray-200">{ip.id}</p>
