        ...
        <div className="prose prose-blue max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Welcome to Insight Run! These Terms of Service ("Terms") govern your access to and use of the Insight Run mobile application ("App"), services, and website (collectively, the "Service"). By downloading, installing, or using the App, you agree to be bound by these Terms.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              The Service is designed to complement, not replace, professional medical advice or coaching services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              <strong>4.1 HealthKit Access:</strong> The App requires access to your Apple HealthKit data to function properly. You control which data the App can access through your device settings.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>4.2 Data Accuracy:</strong> While we strive for accuracy, you acknowledge that the App's insights and recommendations are based on the data provided and may not always be accurate or complete.
            </p>
            <p className="text-gray-700">
              <strong>4.3 Your Responsibility:</strong> You are responsible for ensuring the accuracy of any data you provide and for maintaining the security of your device.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              <strong>IMPORTANT:</strong> The Service is not a substitute for professional medical advice, diagnosis, or treatment.
            </p>
            <p className="text-gray-700 mb-4">
              The insights and recommendations provided by Insight Run are for informational and educational purposes only. Always consult with a qualified healthcare provider before starting any new exercise program or if you have any concerns about your health.
            </p>
            <p className="text-gray-700">
              The Service is not intended to diagnose, treat, cure, or prevent any disease or medical condition. In case of emergency, call your doctor or emergency services immediately.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              <strong>7.1 Our Content:</strong> The Service, including its original content, features, and functionality, is owned by Insight Run and is protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>7.2 Your Data:</strong> You retain all rights to your workout data and personal information. By using the Service, you grant us a limited license to process your data solely to provide the Service.
            </p>
            <p className="text-gray-700">
              <strong>7.3 Trademarks:</strong> Insight Run and related logos are trademarks of Insight Run. You may not use these trademarks without our prior written consent.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Your privacy is important to us. Please review our <a href="/privacy" className="text-blue-600 hover:text-blue-800 underline">Privacy Policy</a> to understand how we collect, use, and protect your information.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              <strong>10.1 Free Features:</strong> Certain features of the Service are currently provided free of charge.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>10.2 Premium Features:</strong> We may offer premium features or subscriptions in the future. Any fees will be clearly disclosed before you make a purchase.
            </p>
            <p className="text-gray-700">
              <strong>10.3 In-App Purchases:</strong> All purchases are processed through the Apple App Store and are subject to Apple's terms and conditions.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL INSIGHT RUN, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              You agree to defend, indemnify, and hold harmless Insight Run and its licensees, affiliates, and their respective officers, directors, employees, and agents from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms or your use of the Service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              <strong>16.1 By You:</strong> You may stop using the Service at any time by deleting the App from your device.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>16.2 By Us:</strong> We may terminate or suspend your access to the Service immediately, without prior notice or liability, if you breach these Terms.
            </p>
            <p className="text-gray-700">
              <strong>16.3 Effect of Termination:</strong> Upon termination, your right to use the Service will immediately cease. Sections of these Terms that by their nature should survive termination shall survive.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Insight Run operates, without regard to its conflict of law provisions. Any disputes arising under these Terms shall be resolved in the appropriate courts of that jurisdiction.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Insight Run regarding the Service and supersede all prior agreements and understandings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <p className="text-gray-700 mb-2">
                <strong>Email:</strong>{' '}
                <a
                  href="mailto:legal@insightrun.app"
                  className="text-blue-600 hover:text-blue-800 underline"
                >
                  legal@insightrun.app
                </a>
              </p>
              <p className="text-gray-700">
          ...
          <section className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-600 text-sm mb-4">
              By using Insight Run, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
