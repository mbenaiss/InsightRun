...
- L'activité peut actualiser le coaching en conservant le score matinal. De nouvelles mesures de récupération ou de sommeil autorisent un nouveau calcul du score. Les anciennes entrées de cache restent décodables.
